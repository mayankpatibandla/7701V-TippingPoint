 ...
 */
ColorUtil::HSL ColorUtil::rgb2hsl(float r, float g, float b) {
 ...
 */
float ColorUtil::hue2rgb(float p, float q, float t) {
 ...
 */
ColorUtil::RGB ColorUtil::hsl2rgb(float h, float s, float l) {
